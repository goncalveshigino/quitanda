...
mixin _$OrdersResult<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(T dara) success,
    required TResult Function(String message) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T dara)? success,
...
class __$$SuccessCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(_$Success<T>(
      freezed == dara
          ? _value.dara
          : dara // ignore: cast_nullable_to_non_nullable
              as T,
    ));
  }
}
...
class _$Success<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'OrdersResult<$T>.success(dara: $dara)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.dara, dara));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(dara));
...
abstract class Success<T> implements OrdersResult<T> {
  factory Success(final T dara) = _$Success<T>;
